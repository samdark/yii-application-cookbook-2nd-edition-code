 ...
 *
 * The followings are the available columns in table 'nicer_but_slower_film_list':
 ...
 */
class NicerButSlowerFilmList extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return NicerButSlowerFilmList the static model class
	 */
