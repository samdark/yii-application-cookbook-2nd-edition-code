 ...
 *
 * The followings are the available columns in table 'customer_list':
 * @property integer $ID
...
class CustomerList extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('notes', 'length', 'max'=>6),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('ID, name, address, zip code, phone, city, country, notes, SID', 'safe', 'on'=>'search'),
		);
	}
